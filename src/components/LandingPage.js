				...
				>
					<div className="flex flex-row sm:flex-col md:flex-col">
						<div className="flex flex-col text-black space-y-24 w-9/12">
							<span className="text-4xl ml-8 font-bold mt-16">
								Our Children, Our future
							</span>
							<p className="flex text-xl ml-8 leading-relaxed py-4">
								Ever thought of improving your children’s eductaion? childTech
							...
							<p className="text-xl ml-8 leading-relaxed mt-0">
								This program will be having children from 7 years to 14 years,
								through ChildTech, children will be able to improve their
								computation skills, problem solving skills, sharpen their minds
								and increase their level of observation thus being creative.
							</p>
							...
							<div className="flex space-x-8 pb-32 justify-center max-w-md mx-auto">
								...
								<span className="animate-pulse inline-flex">
									<Button className="text-xl rounded-lg p-3 leading-tight hover:text-white ">
						...
						<div className="relative top-0 w-full -mr-6 -mt-2 h-screen bg-landp -ml-48">
							<span className="w-4/6 absolute right-0 ">
								<img src={learney} alt="pict" className="mt-20 " />{" "}
							</span>
						</div>
					</div>
								...
								<div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
									<div className="pr-12">
										<h1 className="text-white text-3xl">
											ChildTech is a STEM program that is going to teach
											children about technology.
										</h1>
									</div>
								</div>
							</div>
							...
							<div className="flex flex-wrap items-center mt-32">
								<div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
									...
									<p className="text-lg leading-relaxed mt-0 mb-4 text-gray-900">
										...
										part, through different programs: school program,
										afterschool program, weekend program and holiday program.
									</p>
								</div>
