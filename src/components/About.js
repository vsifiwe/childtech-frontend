				...
				>
					...
					<div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12 pt-96 transform transition cursor-none hover:-translate-y-12 ">
						<div class="bg-blue-400 w-full justify-center shadow rounded p-8 sm:p-12 -mt-72">
							<h1 className="text-center text-white font-semibold lg:text-3xl p-8">
								About ChildTech
							</h1>
							<ul>
								<li class="flex items-center space-x-2">
									...
									<span className="p-2 text-lg text-white">
										ChildTech is a company that is going to teach children about
										technology.
									</span>
								</li>
								<li class="flex items-center space-x-2">
							...
							<div class="flex justify-between mt-8 text-white font-semibold max-w-3xl mx-auto">
								...
								<div class="inline-flex items-center">
									...
									<span className="">
										Kigali city, Gasabo, street KG 594 St
									</span>
								</div>
							</div>
						</div>
