		...
		<div>
			...
			>
				<div
					...
					style={{ backgroundColor: "#F5F4F9" }}
				>
					<div class="flex relative mx-auto w-1/4 mt-16 max-w-md"></div>
					<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 ">
						<div class="text-center pb-12">
							<h1 class="font-bold text-xl md:text-2xl lg:text-3xl font-heading text-gray-900">
								...
								<button class="mx-2 bg-transparent font-normal text-base md:text-xl lg:text-xl hover:bg-blue-500 text-blue-700 font-semibold hover:text-red-600 py-2 px-4 border border-blue-500 hover:border-transparent rounded">
									<Link class="hover:text-red-600" to="/coursepage">
										Find more
									</Link>
								</button>
							</h1>
							<h4>If you don't see all your courses, please reload the page</h4>
						</div>
									...
									return (
                                        ...
                                        <b>{course.price}</b>
												...
												<button
													...
													id="whoobe-t9t5l"
												>
													<Link to="/lessons">Click to Start</Link>
												</button>
											</div>
										</div>
									);
