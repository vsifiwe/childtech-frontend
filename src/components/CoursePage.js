...
import PayButton from "./layout/PayButton";
...
function CoursePage() {
	...
	useEffect(() => {
		...
		axios
			.get("http://childtech.herokuapp.com/api/courses/")
			.then((response) => {
								...
								return isLoading === true ? (
									...
									<div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
										...
										<div class="text-center py-8 sm:py-6">
											...
											<PayButton course={course} user={decoded["user_id"]} />
										</div>
									</div>
								);
							})}
					...
					<section class="w-full pt-16 pb-20">
						<div class="px-10 mx-auto text-center max-w-7xl">
							...
							<p class="mt-3 text-lg text-gray-500">
								Our Unlimited access are designed to meet the needs of
								everybody.
							</p>
							<div class="grid gap-5 mt-12 lg:grid-cols-3 md:grid-cols-2">
								...
								<div class="relative flex flex-col justify-between p-8 lg:p-6 xl:p-8 rounded-2xl">
									...
									<a
										href="#_"
										class="relative flex items-center justify-center w-full px-5 py-4 text-lg font-medium text-white rounded-xl group"
									>
